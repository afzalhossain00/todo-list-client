        ...
        <section>
            <div className="dark:bg-violet-400">
                <div className="container flex flex-col items-center px-4 pb-6 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-12 dark:text-gray-900">
                    ...
                    <p className="mt-2 mb-4 font-semibold text-lg sm:mb-12 xl:max-w-3xl dark:text-gray-900">ToDo List is a task management app that can help you to controll your daily activities</p>
                    <Link to='/addTasks'>
